...
public class ListCategoriesForm extends BaseFormBack {
     public ListCategoriesForm(Form previous,Resources res) throws IOException {
        ...
        list = new ArrayList<>();
        list = ServiceCategorie.getInstance().getAllCategories();
        ...
        for ( Categorie c : list) {
         ...
         Label spl = new Label("categorie name: " + "  " + c.getName()); 
         spl.getAllStyles().setFgColor(0x00000);
         Label spl2 = new Label("categorie description: " + "  " + c.getSlug());
         ...
         Button sup = new Button("Delete");
                ...
                sup.addActionListener((evt) -> {
                   ServiceCategorie.getInstance().Supprimer(c.getId());
                 ...
                 upd.addActionListener((evt) -> {
                        new EditCategorieForm(this.getComponentForm(),res,c.getId()).show();
                    });
